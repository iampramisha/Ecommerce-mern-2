...
// import CartWrapper from './cart-wrapper';
// import { fetchCartItems } from '@/store/shop/cart-slice';
// import { checkAuth, fetchFavorites, logoutUser } from '@/store/auth-slice';
// import { Avatar, AvatarFallback } from '@radix-ui/react-avatar';
// import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuTrigger } from '@radix-ui/react-dropdown-menu';
...
//           <FavoriteComponent favoriteItems={favoriteItems} />
//         </SheetContent>
//       </Sheet>
...
function ShoppingViewHeader() {
  ...
  const { isAuthenticated, user, favorites } = useSelector((state) => state.auth);
    ...
    return (
      <div className='flex flex-row lg:items-center lg:flex-row gap-4'>
        ...
        <Sheet>
          ...
          <SheetContent side="right" className="w-full max-w-md">
            <FavoriteComponent favoriteItems={favorites} />
          </SheetContent>
        </Sheet>
